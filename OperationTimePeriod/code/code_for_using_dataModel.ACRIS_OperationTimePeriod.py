...
dataModel = "OperationTimePeriod"
subject = "dataModel.ACRIS"
ClosingTime = "{'type': 'Property', 'value': {'@type': 'date-time', '@value': '23:59:02Z'}}"
attribute = "ClosingTime"
value = ClosingTime
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))

OpeningTime = "{'type': 'Property', 'value': {'@type': 'date-time', '@value': '00:00:02Z'}}"
attribute = "OpeningTime"
value = OpeningTime
# The next line creates the query for inserting this attribute in a NGSI-LD context broker if the attribute does not exist it creates it
print(sdm.update_broker(dataModel, subject, attribute, value, serverUrl=serverUrl, updateThenCreate=True))
